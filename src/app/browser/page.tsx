  ...
  const openPreview = async (item: Item) => {
    ...
    try {
      ...
      if (dId && dId > 0) {
        ...
        if (isBangumiId(dId)) await fetchBangumiDetails(dId);
        else await fetchDoubanDetails(dId);
      }
    } catch (e: unknown) {
  ...
  return (
    <PageLayout activePath='/source-browser'>
      <div className='max-w-7xl mx-auto space-y-6 -mt-6 md:mt-0 pb-40 md:pb-safe-bottom'>
        {/* Sources - 美化版 (兼容 Tailwind v3) */}
        <div className='bg-gradient-to-br from-white via-emerald-50 to-white dark:from-gray-800 dark:via-emerald-900/10 dark:to-gray-800 rounded-2xl shadow-lg border border-gray-200/80 dark:border-gray-700/80 backdrop-blur-sm'>
        ...
        {activeSource && (
          <div className='bg-gradient-to-br from-white via-blue-50 to-white dark:from-gray-800 dark:via-blue-900/10 dark:to-gray-800 rounded-2xl shadow-lg border border-gray-200/80 dark:border-gray-700/80 backdrop-blur-sm'>
            <div className='px-5 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between'>
              <div className='flex items-center gap-2.5 font-semibold text-gray-900 dark:text-white'>
        ...
        {previewOpen && (
          ...
          >
            <div
              className='w-full max-w-5xl bg-gradient-to-br from-white via-blue-50 to-white dark:from-gray-800 dark:via-blue-900/10 dark:to-gray-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] md:max-h-[90vh] border-2 border-gray-200/50 dark:border-gray-700/50 animate-scaleIn'
